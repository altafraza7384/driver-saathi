    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: `You are a helpful AI assistant for Indian ride-hailing and gig drivers. You help them with:
...
If a driver asks to add income or expense, guide them to use the app's transaction feature.`
          },
          ...messages,
        ],
        stream: true,
